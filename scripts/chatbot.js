...
function initializeChatbot() {
    ...
    function getResponseByType(type) {
        const responses = {
            ...
            `,
            "prices": `
                <p>Стоимость зависит от кол-во бокалов, на заказы свыше 4х бокалов будет скидка, зависит от типа бокала и упаковке, уточнения после подтверждения заказа или напишите нам в <a href="https://www.instagram.com/wine.not.pmr/">Instagram</a>.:</p>
                <ul>
                    <li>Стоимость бокала - от 200 руб</li>
                    <li>При заказе 2х бокалов, скидка 50р - от 350 руб</li>
                    ...
                    <li>Набор из 6ти рюмок в деревянном боксе  - от 475 руб</li>
